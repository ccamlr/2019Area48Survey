function integrand = DWBA_integrandBS(s, k1, r1, r2, a1, a2, betatilt, g1, g2, h1, h2)
% 10/25/2001
...
%global k1 r1 r2 a1 a2 betatilt g1 g2 h1 h2
...
integrand = norm(k1)/4*gamgam.*exp(2*1i*k1.'*rpos./h).*a.*bessy*norm(r2-r1);
